<?php
/**
 * list_vehicles_red.php
 *
 * Returns a JSON array of all vehicles together with the
 * pre‑computed future‑maintenance date (date_futur_entretien).
 * The dashboard modal “Voir les véhicules à entretien imminent”
...
$sql = '
    SELECT
        v.id                     AS id_vehicule,
        v.immatriculation,
        v.date_futur_entretien,          -- <-- the column you need
    ...
    ORDER BY v.date_futur_entretien ASC
';
